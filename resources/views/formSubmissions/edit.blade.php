                        ...
                        <form name="index" id = "index" method="POST" action="{{ route('update-form', $form->transcript->id) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="transcript_number" name="transcript_number" value="{{old('transcript_number', $form->transcript->transcript_number)}}" data-url="{{ route('check.transcript') }}" data-id="{{ $form->transcript->id ?? ''}}" required>
